            ...
            <div class="wf-table">
                ...
                <nav style="" id="navigation" class="wf-td" bitDataAction="site_menu_container"
                    ...
                    <ul id="main-nav" data-st="1" data-sp="1" data-fh="0" data-mw="0" data-lh="40"
                        ...
                        <li class=" menu-item menu-item-type-post_type menu-item-object-page bit-menu-post-id-2160 menu-item-2319">
                        ...
                        <li class=" current-menu-item page_item act first page-item-2160 current_page_item menu-item menu-item-type-post_type menu-item-object-page bit-menu-post-id-9556 menu-item-9557">
...
<div id="yuedu">
    <div class="count-box" style="text-align: center;margin-top: 50px">
        ...
        <script type="text/javascript">
            // 基于准备好的dom，初始化echarts实例
            var myChart = echarts.init(document.getElementById('baobiao11'));
