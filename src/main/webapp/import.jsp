            ...
            <div class="wf-table">
                ...
                <nav style="" id="navigation" class="wf-td" bitDataAction="site_menu_container"
                    ...
                    <ul id="main-nav" data-st="1" data-sp="1" data-fh="0" data-mw="0" data-lh="40"
                        ...
                        <li class=" menu-item menu-item-type-post_type menu-item-object-page page-item-2160 bit-menu-post-id-2160 menu-item-2319">
                            <a href="index.jsp"><span>首页</span></a></li>
                        <li class=" menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item current_page_item act first bit-menu-post-id-7010 menu-item-7011">
...
<img src="image/Aisino.jpg" style="margin-top: 200px;margin-left: 600px">
<div class="file-box" style="text-align: center;margin-top: 0px">
  <form action="" method="post" enctype="multipart/form-data">
   <input type="file" name="fileField" class="file" id="fileField" size="28" onchange="document.getElementById('textfield').value=this.value" />
   <input type="submit" name="submit" class="btn" value="上传" />
   <br><label for="meeting">上传日期：</label>
   <input id="meeting" type="date" value="2017-05-21"/>
  </form>
</div>
</body>
</html>