...
<section data-fixheight="" class="qfy-row-1-592134b61cca9274984 section    full   section-text-no-shadow section-inner-no-shadow section-normal" id="bit_hcbgh" style="margin-bottom:0px;border-radius:0px;color:transparent;">
    ...
    <div class="container">
        <div class="row wpb_row">
            <div data-animalename="qfyfadeInUp" data-delay="" class=" qfy-column-1-592134b61d43c901374 qfy-column-inner  vc_span12  text-default small-screen-undefined fullrow" data-dw="1/1" data-fixheight=""><div style=";position:relative;;" class="column_inner "><div class=" background-overlay grid-overlay-" style="background-color:transparent;"></div><div class="column_containter" style="z-index:3;position:relative;">
                <div m-padding="0px 0px 0px 0px" p-padding="0px 0px 0px 0px" css_animation_delay="0" qfyuuid="qfy_column_text_yqef2" class="qfy-element qfy-text qfy-text-8612 wpb_text_column wpb_content_element  mobile_fontsize21" style="position: relative;;;line-height:1.5em;;background-repeat: no-repeat;;margin-top:0px;margin-bottom:0px;padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;border-radius:0px;">
                    <div class="wpb_wrapper">
                        <div style="position: relative;">
                            <div style="text-align: center;"><span style="color:#666666;"></span>
                                <div style="margin: 0px; padding: 0px; border: 0px; outline: 0px; list-style: none;"><span style="color:#696969;"><span style="font-size: 28px;"><span style="font-family: 微软雅黑;"><strong><span style="font-family: 微軟正黑體;">帮助中心 </span></strong>·Help Center </span><span style="font-family: arial;"center</span></span></span><strong><span style="font-size:40px;"><span style="color: rgb(255, 255, 255);"><span style="font-family: 微軟正黑體;"></span><span style="font-family: 微軟正黑體;"><span style="font-family: arial;"></span></span><span style="font-family: 微軟正黑體;"></span></span></span></strong><span style="color:#666666;"></span></div>
                            </div>
                        </div>

                    </div>
                </div> <div m-padding="9px 0px 0px 0px" p-padding="29px 0px 0px 0px" css_animation_delay="0" qfyuuid="qfy_column_search_8bnbk" class="search_contain qfy-element " style="margin-top:0px;margin-bottom:0px;padding-top:29px;padding-bottom:0px;padding-right:0px;padding-left:0px;">
            </div></div></div></div><style>.qfy-column-1-592134b61d43c901374 > .column_inner:hover{}.qfy-column-1-592134b61d43c901374 > .column_inner:hover >.background-media{}.qfy-column-1-592134b61d43c901374 > .column_inner:hover >.background-overlay{}@media only screen and (min-width: 992px){.qfy-column-1-592134b61d43c901374 > .column_inner {padding-left:0px;padding-right:0px;padding-top:145px;padding-bottom:28px;}.wpb_row .vc_span_class.qfy-column-1-592134b61d43c901374 {};}@media only screen and (max-width: 992px){.qfy-column-1-592134b61d43c901374 > .column_inner{margin:0px auto 0px !important;padding-left:0px;padding-right:0px;padding-top:46px;padding-bottom:28px;}.display_entire .wpb_row .vc_span_class.qfy-column-1-592134b61d43c901374 {};}</style>        </div>
    </div>
    <style>
        @media only screen and (min-width: 992px){
            section.section.qfy-row-1-592134b61cca9274984{padding-left:0px;padding-right:0px;padding-top:20px;padding-bottom:68px;margin-top:0px;}section.section.qfy-row-1-592134b61cca9274984 > .container{max-width:1024px;margin:0 auto;}}


        @media only screen and (max-width: 992px){
            .bit-html section.section.qfy-row-1-592134b61cca9274984{padding-left:15px;padding-right:15px;padding-top:1px;padding-bottom:26px;margin-top:0px;}}
    </style>
</section>
<div class="container">
    <div class="row wpb_row">
            ...
            <div style="margin-top:0px;margin-bottom:0px;margin-left:0px;margin-right:0px;border-radius:0px;;position:relative;;"
                ...
                <div class="column_containter" style="z-index:3;position:relative;">
                    <section data-fixheight=""
                             class="qfy-row-3-592134b61e3b0564954 section     bothfull  section-text-no-shadow section-inner-no-shadow section-normal display_entire"
                        ...
                        <div class="container">
                            <div class="row wpb_row">
                                <div data-animalename="qfyfadeInUp" data-delay=""
                                     class=" qfy-column-3-592134b61e5b8657267 qfy-column-inner vc_span_class vc_span6  text-Default small-screen-Default"
                                     data-dw="1/2" data-fixheight="">
                                    <div style="margin-top:0px;margin-bottom:0px;margin-left:10px;margin-right:10px;border-radius:0px;border-top:1px solid #cecece;border-bottom:1px solid #cecece;border-left:1px solid #cecece;border-right:1px solid #cecece;;position:relative;;"
                                         class="column_inner ">
                                        <div class=" background-overlay grid-overlay-0"
                                             style="background-color:transparent;"></div>
                                        <div class="column_containter" style="z-index:3;position:relative;">
                                            <div m-padding="0px 0px 16px 0px" p-padding="9px 0px 16px 0px"
                                                 css_animation_delay="0" qfyuuid="qfy_column_text_dvu67"
                                                 class="qfy-element qfy-text qfy-text-54637 wpb_text_column wpb_content_element  mobile_fontsize14"
                                                 style="position: relative;;;line-height:1.5em;;background-color: transparent;background-repeat: no-repeat;;margin-top:20px;padding-top:9px;padding-bottom:16px;padding-right:0px;padding-left:0px;">
                                                <div class="wpb_wrapper">
                                                    <div style="text-align: center;"><span style="font-size:22px;"><span
                                                            style="font-family: 微软雅黑;"> <span
                                                            style="font-size: 18px;"><span style="letter-spacing: 0px;"><span
                                                            style="color: rgb(51, 51, 51);"> 如何导入数据</span></span></span></span></span>
                                                    </div>

                                                    <div><span style="font-size:15px;"><strong><span
                                                            style="color:#FFFFFF;"></span></strong></span><span
                                                            style="font-family:宋体;"></span>

                                                        <div style="text-align: center;"><span
                                                                style="font-family: Arial, Verdana, 'Microsoft YaHei'; font-size: 14px; word-spacing: normal;"></span>
                                                        </div>
                                                    </div>

                                                </div>
                                            </div>
                                            <div id="icon-592134b61ec9e310888"
                                                 style="margin-top:0px;margin-bottom:0px;padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;"
                                                 m-padding="0px 0px 0px 0px" p-padding="0px 0px 0px 0px"
                                                 css_animation_delay="0" qfyuuid="qfy_icon_bnp45"
                                                ...
                                                <style>
                                                    #icon-592134b61ec9e310888 .vc_icon_element-inner:hover .vc_icon_element-icon, .hover #icon-592134b61ec9e310888 .vc_icon_element-inner .vc_icon_element-icon {
                                                        color: #adadad !important
                                                    }

                                                    #icon-592134b61ec9e310888 .vc_icon_element-inner:hover, .hover #icon-592134b61ec9e310888 .vc_icon_element-inner {
                                                ...
                                                <div class=" vc_icon_element-inner vc_icon_element-color- vc_icon_element-have-style-inner vc_icon_element-size-sm vc_icon_element-style-rounded-outline vc_icon_element-outline vc_icon_element-background-color-"
                                                    ...
                                                    <span class="vc_icon_element-icon glyphicon glyphicon-phone"
                                            ...
                                            <div m-padding="0px 0px 0px 0px" p-padding="13px 0px 0px 0px"
                                                 css_animation_delay="0" qfyuuid="qfy_column_text_2rizo"
                                                 class="qfy-element qfy-text qfy-text-44913 wpb_text_column wpb_content_element  mobile_fontsize12"
                                                 style="position: relative;;;line-height:1.5em;;background-color: transparent;background-repeat: no-repeat;;margin-top:0px;margin-bottom:0px;padding-top:13px;padding-bottom:0px;padding-right:0px;padding-left:0px;border-radius:0px;">
                                                <div class="wpb_wrapper">
                                                    <div style="text-align: center;"><span style="color:#696969;"><span
                                                            style="font-family: 微软雅黑;"><span style="font-size: 15px;">快速导入</span></span></span>
                                                    </div>

                                                    <div style="text-align: center;"><span style="color:#696969;"><span
                                                            style="font-family: 微软雅黑;"><span style="font-size: 15px;">发票数据</span></span></span>
                                                    </div>

                                                </div>
                                            </div>
                                            <div m-padding="0px 0px 16px 0px" p-padding="0px 0px 16px 0px"
                                                 css_animation_delay="0" qfyuuid="qfy_column_text_dvu67"
                                                 class="qfy-element qfy-text qfy-text-37399 wpb_text_column wpb_content_element  mobile_fontsize14"
                                                ...
                                                <div class="wpb_wrapper">
                                                    <div style="text-align: center;"><a
                                                            ...
                                                            style="color: rgb(73, 159, 245);">查看更多<span
                                                            style="font-size:14px;"><span
                                                            style="font-family: 微软雅黑;"><span
                                                            style="color:#3399ff;">&gt;</span></span></span></span></span></span></a>
                                                    </div>
                                ...
                                <style>.qfy-column-3-592134b61e5b8657267 > .column_inner:hover {
                                }

                                .qfy-column-3-592134b61e5b8657267 > .column_inner:hover > .background-media {
                                }

                                .qfy-column-3-592134b61e5b8657267 > .column_inner:hover > .background-overlay {
                                }

                                @media only screen and (min-width: 992px) {
                                    .qfy-column-3-592134b61e5b8657267 > .column_inner {
                                        padding-left: 0px;
                                        padding-right: 0px;
                                        padding-top: 0px;
                                        padding-bottom: 0px;
                                    ...
                                    .wpb_row .vc_span_class.qfy-column-3-592134b61e5b8657267 {
                                    }
                                ...
                                @media only screen and (max-width: 992px) {
                                    ...
                                    .display_entire .wpb_row .vc_span_class.qfy-column-3-592134b61e5b8657267 {
                                    }

                                ;
                                }</style>
                                <div data-animalename="qfyfadeInUp" data-delay=""
                                     class=" qfy-column-4-592134b61f274474529 qfy-column-inner vc_span_class vc_span6  text-Default small-screen-Default"
                                     data-dw="1/2" data-fixheight="">
                                    <div style="margin-top:0px;margin-bottom:0px;margin-left:10px;margin-right:10px;border-radius:0px;border-top:1px solid #cecece;border-bottom:1px solid #cecece;border-left:1px solid #cecece;border-right:1px solid #cecece;;position:relative;;"
                                         class="column_inner ">
                                        <div class=" background-overlay grid-overlay-0"
                                        ...
                                        <div class="column_containter" style="z-index:3;position:relative;">
                                            <div m-padding="0px 0px 16px 0px" p-padding="9px 0px 16px 0px"
                                                 css_animation_delay="0" qfyuuid="qfy_column_text_dvu67"
                                                 class="qfy-element qfy-text qfy-text-13753 wpb_text_column wpb_content_element  mobile_fontsize14"
                                                 style="position: relative;;;line-height:1.5em;;background-color: transparent;background-repeat: no-repeat;;margin-top:20px;padding-top:9px;padding-bottom:16px;padding-right:0px;padding-left:0px;">
                                                <div class="wpb_wrapper">
                                                    <div style="text-align: center;"><span style="font-size:22px;"><span
                                                            style="font-family: 微软雅黑;"> <span
                                                            style="font-size: 18px;"><span style="letter-spacing: 0px;"><span
                                                            style="color: rgb(51, 51, 51);"> 如何查询数据</span></span></span></span></span>
                                                    </div>
                                            ...
                                            <div id="icon-592134b61f6d37139"
                                                 style="margin-top:0px;margin-bottom:0px;padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;"
                                                 m-padding="0px 0px 0px 0px" p-padding="0px 0px 0px 0px"
                                                 css_animation_delay="0" qfyuuid="qfy_icon_bnp45"
                                                 class="qfy-element vc_icon_element vc_icon_element-outer delay0 vc_icon_element-align-center vc_icon_element-have-style icon-fontawesome">
                                                <style>
                                                    #icon-592134b61f6d37139 .vc_icon_element-inner:hover .vc_icon_element-icon, .hover #icon-592134b61f6d37139 .vc_icon_element-inner .vc_icon_element-icon {
                                                        color: #adadad !important
                                                    }

                                                    #icon-592134b61f6d37139 .vc_icon_element-inner:hover, .hover #icon-592134b61f6d37139 .vc_icon_element-inner {
                                                        border-color: #adadad !important;
                                                    }</style>
                                                <div class=" vc_icon_element-inner vc_icon_element-color- vc_icon_element-have-style-inner vc_icon_element-size-sm vc_icon_element-style-rounded-outline vc_icon_element-outline vc_icon_element-background-color-"
                                                     style="border-color:#adadad;border-width:1px;">
                                            ...
                                            <div m-padding="0px 0px 0px 0px" p-padding="13px 0px 0px 0px"
                                                 css_animation_delay="0" qfyuuid="qfy_column_text_2rizo"
                                                 class="qfy-element qfy-text qfy-text-72273 wpb_text_column wpb_content_element  mobile_fontsize12"
                                                 style="position: relative;;;line-height:1.5em;;background-color: transparent;background-repeat: no-repeat;;margin-top:0px;margin-bottom:0px;padding-top:13px;padding-bottom:0px;padding-right:0px;padding-left:0px;border-radius:0px;">
                                                <div class="wpb_wrapper">
                                                    <div style="text-align: center;"><span style="color:#696969;"><span
                                                            style="font-family: 微软雅黑;"><span style="font-size: 15px;">方便快捷</span></span></span>
                                                    </div>

                                                    <div style="text-align: center;"><span style="color:#696969;"><span
                                                            style="font-family: 微软雅黑;"><span style="font-size: 15px;">快速查询</span></span></span>
                                                    </div>
                                            ...
                                            <div m-padding="0px 0px 16px 0px" p-padding="0px 0px 16px 0px"
                                                 css_animation_delay="0" qfyuuid="qfy_column_text_dvu67"
                                                 class="qfy-element qfy-text qfy-text-53064 wpb_text_column wpb_content_element  mobile_fontsize14"
                                                 style="position: relative;;;line-height:1.5em;;background-color: transparent;background-repeat: no-repeat;;margin-top:20px;padding-top:0px;padding-bottom:16px;padding-right:0px;padding-left:0px;">
                                                <div class="wpb_wrapper">
                                                    <div style="text-align: center;"><a
                                ...
                                <style>.qfy-column-4-592134b61f274474529 > .column_inner:hover {
                                }

                                .qfy-column-4-592134b61f274474529 > .column_inner:hover > .background-media {
                                }

                                .qfy-column-4-592134b61f274474529 > .column_inner:hover > .background-overlay {
                                }

                                @media only screen and (min-width: 992px) {
                                    .qfy-column-4-592134b61f274474529 > .column_inner {
                                        padding-left: 0px;
                                        padding-right: 0px;
                                        padding-top: 0px;
                                        padding-bottom: 0px;
                                    ...
                                    .wpb_row .vc_span_class.qfy-column-4-592134b61f274474529 {
                                    }
                                ...
                                @media only screen and (max-width: 992px) {
                                    ...
                                    .display_entire .wpb_row .vc_span_class.qfy-column-4-592134b61f274474529 {
                                    }
                        ...
                        <style>
                            @media only screen and (min-width: 992px) {
                                section.section.qfy-row-3-592134b61e3b0564954 {
                                    padding-left: 0px;
                                    padding-right: 0px;
                                    padding-top: 0px;
                                    padding-bottom: 0px;
                            ...
                            @media only screen and (max-width: 992px) {
                                .bit-html section.section.qfy-row-3-592134b61e3b0564954 {
                                    padding-left: 15px;
                                    padding-right: 15px;
                                    padding-top: 0px;
                                    padding-bottom: 0px;
        ...
        <style>.qfy-column-2-592134b61e1ad788989 > .column_inner:hover {
        }

        .qfy-column-2-592134b61e1ad788989 > .column_inner:hover > .background-media {
        }

        .qfy-column-2-592134b61e1ad788989 > .column_inner:hover > .background-overlay {
        }

        @media only screen and (min-width: 992px) {
            .qfy-column-2-592134b61e1ad788989 > .column_inner {
                padding-left: 0px;
                padding-right: 0px;
                padding-top: 0px;
                padding-bottom: 0px;
            ...
            .wpb_row .vc_span_class.qfy-column-2-592134b61e1ad788989 {
            }
        ...
        @media only screen and (max-width: 992px) {
            ...
            .display_entire .wpb_row .vc_span_class.qfy-column-2-592134b61e1ad788989 {
            }

        ;
        }</style>
        <div data-animalename="qfyfadeInUp" data-delay=""
             class=" qfy-column-5-592134b61fcac403331 qfy-column-inner vc_span_class vc_span6  text-default small-screen-undefined"
             data-dw="1/2" data-fixheight="">
            <div style=";position:relative;;" class="column_inner ">
                ...
                <div class="column_containter" style="z-index:3;position:relative;">
                    <section data-fixheight=""
                             class="qfy-row-4-592134b61fea4168614 section     bothfull  section-text-no-shadow section-inner-no-shadow section-normal display_entire"
                             style='margin-bottom:0px;border-radius:0px;color:#000000;'>
                        <div class="section-background-overlay background-overlay grid-overlay-0 "
                             style="background-color: transparent;"></div>
                        ...
                        <div class="container">
                            <div class="row wpb_row">
                                <div data-animalename="qfyfadeInUp" data-delay=""
                                     class=" qfy-column-6-592134b6200a6228883 qfy-column-inner vc_span_class vc_span6  text-Default small-screen-Default"
                                     data-dw="1/2" data-fixheight="">
                                    <div style="margin-top:0px;margin-bottom:0px;margin-left:10px;margin-right:10px;border-radius:0px;border-top:1px solid #cecece;border-bottom:1px solid #cecece;border-left:1px solid #cecece;border-right:1px solid #cecece;;position:relative;;"
                                         class="column_inner ">
                                        <div class=" background-overlay grid-overlay-0"
                                        ...
                                        <div class="column_containter" style="z-index:3;position:relative;">
                                            <div m-padding="0px 0px 16px 0px" p-padding="9px 0px 16px 0px"
                                                 css_animation_delay="0" qfyuuid="qfy_column_text_dvu67"
                                                 class="qfy-element qfy-text qfy-text-67058 wpb_text_column wpb_content_element  mobile_fontsize14"
                                                 style="position: relative;;;line-height:1.5em;;background-color: transparent;background-repeat: no-repeat;;margin-top:20px;padding-top:9px;padding-bottom:16px;padding-right:0px;padding-left:0px;">
                                                <div class="wpb_wrapper">
                                                    <div style="text-align: center;"><span style="font-size:22px;"><span
                                                            style="font-family: 微软雅黑;"> <span
                                                            style="font-size: 18px;"><span style="letter-spacing: 0px;"><span
                                                            style="color: rgb(51, 51, 51);"> 如何统计数据</span></span></span></span></span>
                                                    </div>
                                            ...
                                            <div id="icon-592134b620527996787"
                                                 style="margin-top:0px;margin-bottom:0px;padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;"
                                                 m-padding="0px 0px 0px 0px" p-padding="0px 0px 0px 0px"
                                                 css_animation_delay="0" qfyuuid="qfy_icon_bnp45"
                                                 class="qfy-element vc_icon_element vc_icon_element-outer delay0 vc_icon_element-align-center vc_icon_element-have-style icon-fontawesome">
                                                <style>
                                                    #icon-592134b620527996787 .vc_icon_element-inner:hover .vc_icon_element-icon, .hover #icon-592134b620527996787 .vc_icon_element-inner .vc_icon_element-icon {
                                                        color: #adadad !important
                                                    }

                                                    #icon-592134b620527996787 .vc_icon_element-inner:hover, .hover #icon-592134b620527996787 .vc_icon_element-inner {
                                                        border-color: #adadad !important;
                                                    }</style>
                                                <div class=" vc_icon_element-inner vc_icon_element-color- vc_icon_element-have-style-inner vc_icon_element-size-sm vc_icon_element-style-rounded-outline vc_icon_element-outline vc_icon_element-background-color-"
                                                     style="border-color:#adadad;border-width:1px;">
                                            ...
                                            <div m-padding="0px 0px 0px 0px" p-padding="13px 0px 0px 0px"
                                                 css_animation_delay="0" qfyuuid="qfy_column_text_2rizo"
                                                 class="qfy-element qfy-text qfy-text-52039 wpb_text_column wpb_content_element  mobile_fontsize12"
                                                 style="position: relative;;;line-height:1.5em;;background-color: transparent;background-repeat: no-repeat;;margin-top:0px;margin-bottom:0px;padding-top:13px;padding-bottom:0px;padding-right:0px;padding-left:0px;border-radius:0px;">
                                                <div class="wpb_wrapper">
                                                    <div style="text-align: center;"><span style="color:#696969;"><span
                                                            style="font-family: 微软雅黑;"><span style="font-size: 15px;">一键建表</span></span></span>
                                                    </div>

                                                    <div style="text-align: center;"><span style="color:#696969;"><span
                                                            style="font-family: 微软雅黑;"><span style="font-size: 15px;">直观简洁</span></span></span>
                                                    </div>
                                            ...
                                            <div m-padding="0px 0px 16px 0px" p-padding="0px 0px 16px 0px"
                                                 css_animation_delay="0" qfyuuid="qfy_column_text_dvu67"
                                                 class="qfy-element qfy-text qfy-text-72013 wpb_text_column wpb_content_element  mobile_fontsize14"
                                                 style="position: relative;;;line-height:1.5em;;background-color: transparent;background-repeat: no-repeat;;margin-top:20px;padding-top:0px;padding-bottom:16px;padding-right:0px;padding-left:0px;">
                                                <div class="wpb_wrapper">
                                                    <div style="text-align: center;"><a
                                                            href="help_count.jsp"
                                ...
                                <style>.qfy-column-6-592134b6200a6228883 > .column_inner:hover {
                                }

                                .qfy-column-6-592134b6200a6228883 > .column_inner:hover > .background-media {
                                }

                                .qfy-column-6-592134b6200a6228883 > .column_inner:hover > .background-overlay {
                                }

                                @media only screen and (min-width: 992px) {
                                    .qfy-column-6-592134b6200a6228883 > .column_inner {
                                        padding-left: 0px;
                                        padding-right: 0px;
                                        padding-top: 0px;
                                        padding-bottom: 0px;
                                    ...
                                    .wpb_row .vc_span_class.qfy-column-6-592134b6200a6228883 {
                                    }
                                ...
                                @media only screen and (max-width: 992px) {
                                    ...
                                    .display_entire .wpb_row .vc_span_class.qfy-column-6-592134b6200a6228883 {
                                    }

                                ;
                                }</style>
                                <div data-animalename="qfyfadeInUp" data-delay=""
                                     class=" qfy-column-7-592134b620b18676526 qfy-column-inner vc_span_class vc_span6  text-Default small-screen-Default"
                                     data-dw="1/2" data-fixheight="">
                                    <div style="margin-top:0px;margin-bottom:0px;margin-left:10px;margin-right:10px;border-radius:0px;border-top:1px solid #cecece;border-bottom:1px solid #cecece;border-left:1px solid #cecece;border-right:1px solid #cecece;;position:relative;;"
                                         class="column_inner ">
                                        <div class=" background-overlay grid-overlay-0"
                                        ...
                                        <div class="column_containter" style="z-index:3;position:relative;">
                                            <div m-padding="0px 0px 16px 0px" p-padding="9px 0px 16px 0px"
                                                 css_animation_delay="0" qfyuuid="qfy_column_text_dvu67"
                                                 class="qfy-element qfy-text qfy-text-99713 wpb_text_column wpb_content_element  mobile_fontsize14"
                                                 style="position: relative;;;line-height:1.5em;;background-color: transparent;background-repeat: no-repeat;;margin-top:20px;padding-top:9px;padding-bottom:16px;padding-right:0px;padding-left:0px;">
                                                <div class="wpb_wrapper">
                                                    <div style="text-align: center;"><span style="font-size:22px;"><span
                                                            style="font-family: 微软雅黑;"> <span
                                                            style="font-size: 18px;"><span style="letter-spacing: 0px;"><span
                                                            style="color: rgb(51, 51, 51);"> 如何获取报表</span></span></span></span></span>
                                                    </div>
                                            ...
                                            <div id="icon-592134b620ff8563964"
                                                 style="margin-top:0px;margin-bottom:0px;padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;"
                                                 m-padding="0px 0px 0px 0px" p-padding="0px 0px 0px 0px"
                                                 css_animation_delay="0" qfyuuid="qfy_icon_bnp45"
                                                 class="qfy-element vc_icon_element vc_icon_element-outer delay0 vc_icon_element-align-center vc_icon_element-have-style icon-fontawesome">
                                                <style>
                                                    #icon-592134b620ff8563964 .vc_icon_element-inner:hover .vc_icon_element-icon, .hover #icon-592134b620ff8563964 .vc_icon_element-inner .vc_icon_element-icon {
                                                        color: #adadad !important
                                                    }

                                                    #icon-592134b620ff8563964 .vc_icon_element-inner:hover, .hover #icon-592134b620ff8563964 .vc_icon_element-inner {
                                                        border-color: #adadad !important;
                                                    }</style>
                                                <div class=" vc_icon_element-inner vc_icon_element-color- vc_icon_element-have-style-inner vc_icon_element-size-sm vc_icon_element-style-rounded-outline vc_icon_element-outline vc_icon_element-background-color-"
                                                     style="border-color:#adadad;border-width:1px;">
                                            ...
                                            <div m-padding="0px 0px 0px 0px" p-padding="13px 0px 0px 0px"
                                                 css_animation_delay="0" qfyuuid="qfy_column_text_2rizo"
                                                 class="qfy-element qfy-text qfy-text-55223 wpb_text_column wpb_content_element  mobile_fontsize12"
                                                 style="position: relative;;;line-height:1.5em;;background-color: transparent;background-repeat: no-repeat;;margin-top:0px;margin-bottom:0px;padding-top:13px;padding-bottom:0px;padding-right:0px;padding-left:0px;border-radius:0px;">
                                                <div class="wpb_wrapper">
                                                    <div style="text-align: center;"><span style="color:#696969;"><span
                                                            style="font-family: 微软雅黑;"><span style="font-size: 15px;">趋势分析</span></span></span>
                                                    </div>

                                                    <div style="text-align: center;"><span style="color:#696969;"><span
                                                            style="font-family: 微软雅黑;"><span style="font-size: 15px;">给出意见</span></span></span>
                                                    </div>
                                            ...
                                            <div m-padding="0px 0px 16px 0px" p-padding="0px 0px 16px 0px"
                                                 css_animation_delay="0" qfyuuid="qfy_column_text_dvu67"
                                                 class="qfy-element qfy-text qfy-text-68901 wpb_text_column wpb_content_element  mobile_fontsize14"
                                                 style="position: relative;;;line-height:1.5em;;background-color: transparent;background-repeat: no-repeat;;margin-top:20px;padding-top:0px;padding-bottom:16px;padding-right:0px;padding-left:0px;">
                                                <div class="wpb_wrapper">
                                                    <div style="text-align: center;"><a
                                ...
                                <style>.qfy-column-7-592134b620b18676526 > .column_inner:hover {
                                }

                                .qfy-column-7-592134b620b18676526 > .column_inner:hover > .background-media {
                                }

                                .qfy-column-7-592134b620b18676526 > .column_inner:hover > .background-overlay {
                                }

                                @media only screen and (min-width: 992px) {
                                    .qfy-column-7-592134b620b18676526 > .column_inner {
                                        padding-left: 0px;
                                        padding-right: 0px;
                                        padding-top: 0px;
                                        padding-bottom: 0px;
                                    ...
                                    .wpb_row .vc_span_class.qfy-column-7-592134b620b18676526 {
                                    }
                                ...
                                @media only screen and (max-width: 992px) {
                                    ...
                                    .display_entire .wpb_row .vc_span_class.qfy-column-7-592134b620b18676526 {
                                    }
                        ...
                        <style>
                            @media only screen and (min-width: 992px) {
                                section.section.qfy-row-4-592134b61fea4168614 {
                                    padding-left: 0px;
                                    padding-right: 0px;
                                    padding-top: 0px;
                                    padding-bottom: 0px;
                            ...
                            @media only screen and (max-width: 992px) {
                                .bit-html section.section.qfy-row-4-592134b61fea4168614 {
                                    padding-left: 15px;
                                    padding-right: 15px;
                                    padding-top: 0px;
                                    padding-bottom: 0px;
        ...
        <style>.qfy-column-5-592134b61fcac403331 > .column_inner:hover {
        }

        .qfy-column-5-592134b61fcac403331 > .column_inner:hover > .background-media {
        }

        .qfy-column-5-592134b61fcac403331 > .column_inner:hover > .background-overlay {
        }

        @media only screen and (min-width: 992px) {
            .qfy-column-5-592134b61fcac403331 > .column_inner {
                padding-left: 0px;
                padding-right: 0px;
                padding-top: 0px;
                padding-bottom: 0px;
            ...
            .wpb_row .vc_span_class.qfy-column-5-592134b61fcac403331 {
            }
        ...
        @media only screen and (max-width: 992px) {
            ...
            .display_entire .wpb_row .vc_span_class.qfy-column-5-592134b61fcac403331 {
            }
...
<style>
    @media only screen and (min-width: 992px) {
        section.section.qfy-row-2-592134b61deb0294530 {
            padding-left: 0px;
            padding-right: 0px;
            padding-top: 0px;
            padding-bottom: 0px;
        ...
        section.section.qfy-row-2-592134b61deb0294530 > .container {
            max-width: 1024px;
            margin: 0 auto;
        }
    }
    ...
    @media only screen and (max-width: 992px) {
        .bit-html section.section.qfy-row-2-592134b61deb0294530 {
            padding-left: 15px;
            padding-right: 15px;
            padding-top: 0px;
            padding-bottom: 0px;
...
<section data-fixheight=""
         class="qfy-row-5-592134b621746431783 section    full   section-text-no-shadow section-inner-no-shadow section-normal"
         id="bit_yx7b6" style='margin-bottom:0px;border-radius:0px;color:#000000;'>
    <div class="section-background-overlay background-overlay grid-overlay-0 "
         style="background-color: transparent;"></div>
    ...
    <div class="container">
        <div class="row wpb_row">
            <div data-animalename="qfyfadeInUp" data-delay=""
                 class=" qfy-column-8-592134b621962713053 qfy-column-inner  vc_span12  text-default small-screen-undefined fullrow"
                 data-dw="1/1" data-fixheight="">
                <div style=";position:relative;;" class="column_inner ">
                    <div class=" background-overlay grid-overlay-" style="background-color:transparent;"></div>
                    <div class="column_containter" style="z-index:3;position:relative;">
                        <style>@media only screen and (max-width: 760px) {
                            #vc_header_592134b6220ff964 .header_title {
                                font-size: 20px !important;
                            }
                        }</style>
                        <style>@media only screen and (max-width: 760px) {
                            #vc_header_592134b6220ff964 .header_subtitle {
                                font-size: 14px !important;
                            }
                        }</style>
                        <div id="vc_header_592134b6220ff964" m-padding="0px 0px 21px 0px" p-padding="0px 0px 21px 0px"
                             css_animation_delay="0" qfyuuid="qfy_header_folnq"
                             class="qfy-element minheigh1px wpb_text_column wpb_content_element "
                             style="position: relative;;;background-repeat: no-repeat;;margin-top:0px;margin-bottom:0px;padding-top:0px;padding-bottom:21px;padding-right:0px;padding-left:0px;">
                        </div>
                    </div>
                </div>
            </div>
