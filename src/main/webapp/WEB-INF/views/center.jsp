...
<div class="container" style="margin-top: 20px;">
    ...
    <div class="tab-content" style="text-align: center;">
        ...
        <div id="modify" class="tab-pane fade" style="text-align: center;">
            <div>
                <form action="" class="qfyuser-label" style="margin-top: 125px;margin-left: 30%;">
                    <div style="font-size: medium;width: 120px;float: left;">修改电话：</div>
                    ...
                    <input class="form-control" type="password" style="font-size: medium;width: 200px;float: left;margin-left: 50px"><br><br><br>
                    <input class="btn-xs btn-primary form-control" style="font-size: medium;width: 100px;float: left;margin-left: 150px" type="submit" value="确定">
                </form>
            </div>
        </div>
    </div>
