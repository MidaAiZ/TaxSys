                                                                        ...
                                                                        <div class="row wpb_row">
                                                                            ...
                                                                            <div class="qfy-column-3-5918701b52ae12925 qfy-column-inner vc_span_class vc_span6  text-Default small-screen-Default" data-dw="1/2" data-fixheight="">
                                                                                <div style="max-width:480px;margin-top:0px;margin-bottom:0px;margin-left:0px;margin-right:0px;border-radius:5px;;position:relative;overflow:hidden;;" class="column_inner ">
                                                                                    ...
                                                                                    <div class="column_containter" style="z-index:3;position:relative;">
                                                                                        <div m-padding="10px 0px 10px 0px" p-padding="10px 0px 10px 0px" css_animation_delay="0" qfyuuid="qfy_column_text_e5p3n" class="qfy-element qfy-text qfy-text-89190 wpb_text_column wpb_content_element " style="position: relative;;background-color: #104f68;background-repeat: no-repeat;;margin-top:0px;margin-bottom:0px;padding-top:5px;padding-bottom:10px;padding-right:0px;padding-left:0px;border-radius:0px;">
